...
displayDiscount = () => {
    ...
    for(let i = 0; i < checkout.length; i++){
        ...
        if(discountCode === "SAVE20"){
            discountTotal = discountTotal * (80/100)
          } 

        // .toExponential.fixed(2)

        // if(discountCode === "SAVE20"){
        //     discountTotal = discountTotal * (80/100)
        //     alert("Your order has been discounted! Thank you for your support.")
        //   } else {
        //     alert("Oh Nooo, seems like your discount code is incorrect".)
        //   }
